...
/*   Updated: 2023/10/31 15:11:29 by gvigano          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*int	main(int argc, char *argv[])
{
	if (argc > 0)
	{
		printf("il mio risultato: %d", ft_strncmp(argv[1], argv[2], ft_atoi(argv[3])));
		printf("\n l'originale: %d", strncmp(argv[1], argv[2], ft_atoi(argv[3])));
	}
	return (0);
}*/
