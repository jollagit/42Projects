...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/26 12:01:37 by gvigano           #+#    #+#             */
/*   Updated: 2025/07/26 12:01:37 by gvigano          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void) : name("Default"), hitPoints(10), energyPoints(10), attackDamage(0) {
	std::cout << "Default costructor called for: " << this->name << std::endl;
}
...
void	ClapTrap::takeDamage(unsigned int amount) {
	...
	if (amount >= this->hitPoints) {
		this->hitPoints = 0;
		std::cout << "ClapTrap " << this->name << " take this amount of damage: " << amount
				  << ", end dies!!" << std::endl;
		return;
	} else {
